const Footer = () => {
    return (
        <footer className="bg-gradient-to-r from-black via-gray-900 to-gray-800 text-gray-300 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-8 border-b border-gray-700">
                    ...
                    <div className="md:col-span-4">
                        <div className="flex items-center mb-4">
                            ...
                            <h3 className="text-white font-bold text-xl">Topify</h3>
                        </div>
                        <p className="text-sm text-gray-400 mb-4 leading-relaxed">
                            Topify Digital Services Limited<br />
                            Empowering payments, one card at a time.
                        </p>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <ul className="space-y-3">
                            <li><a href="#cards" className="text-gray-400 hover:text-white transition-colors text-sm">Cards</a></li>
                            <li><a href="#wallets" className="text-gray-400 hover:text-white transition-colors text-sm">Wallets</a></li>
                            <li><a href="#payments" className="text-gray-400 hover:text-white transition-colors text-sm">Payments</a></li>
                        ...
                        <div className="flex flex-col space-y-3">
                            ...
                            <div className="flex">
                                <input
                                    ...
                                    className="px-3 py-2 bg-gray-800 border border-gray-700 rounded-l text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 w-full"
                                />
                                <button className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-r text-sm transition-colors">
                                    Subscribe
                                </button>
                            </div>
                        </div>
                ...
                <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="text-sm text-gray-400">
                        © {new Date().getFullYear()} Topify Digital Services Limited. All rights reserved.
                    </div>
